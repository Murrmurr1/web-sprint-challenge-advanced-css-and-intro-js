...
function get20s(a){
  ...
  var ageInt1 = parseInt(artists[i].years.slice(0,4))
  var ageInt2 = parseInt(artists[i].years.slice(7,11))
    if (ageInt1 >= 1800 && ageInt2 <= 1899 ) {
      newArr.push(a[i].name)
    }
  }
  console.log(newArr)
  }
...
function addArtist(artists){
  const newArtist = {
    ...
    "bio": "Just a 21 year old junior web developer in training! While i enjoy all aspects of web development so far, back end definitely seems like the part ill like the most. I'm much more of a functionality guy over aesthetics anyhow."
  }
